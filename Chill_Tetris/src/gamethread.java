...
public class gamethread extends Thread {
	...
	//when threadflag is 1
	public static void isthreadflag0() {
		flag = 0;
		setblock();
		x++;
	}
	...
	public static void randomY() {
		...
		else if (blocknum==3 || blocknum==5 || blocknum==7 || blocknum==9 || blocknum==12 || blocknum==14 || blocknum==16 || blocknum==18) {
...
//		}
    ...
    public static void blockdownreferee() {
    	...
    	if(blocknum==1) {
    	...
    	else if ((blocknum==3)||(blocknum==7)||(blocknum==14)) {
    		...
    		if((x>vertical-4)||((board[x+3][y]!=0)||(board[x+1][y+1]!=0))) {
    			threadflag = 1;
    		}
    		else
    			isthreadflag0();
    		...
    		if((x>vertical-3)||((board[x+1][y]!=0)||(board[x+1][y+1]!=0)||(board[x+2][y+2]!=0))) {
    			threadflag = 1;
    		}
    		else
    			isthreadflag0();
    	}
    	else if ((blocknum==6)||(blocknum==8)) {
    		...
    		if((x>vertical-3)||((board[x+2][y]!=0)||(board[x+1][y+1]!=0)||(board[x+1][y+2]!=0))) {
    			threadflag = 1;
    		}
    		else
    			isthreadflag0();
    		...
    		if((x>vertical-4)||((board[x+1][y]!=0)||(board[x+2][y+1]!=0))) {
    			threadflag = 1;
    		}
    		else
    			isthreadflag0();
    	...
    	else if ((blocknum==13)||(blocknum==17)) {
    	...
    	else if ((blocknum==15)||(blocknum==19)) {
    		...
    		if((x>vertical-3)||((board[x+1][y]!=0)||(board[x+2][y+1]!=0)||(board[x+1][y+2]!=0))) {
    			threadflag = 1;
    		}
    		else
    			isthreadflag0();
